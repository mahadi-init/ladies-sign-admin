              ...
              >
                ...
                <header id="header-1a" className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="inline-flex h-10 items-center justify-center gap-2 justify-self-center whitespace-nowrap rounded-full px-5 text-sm font-medium tracking-wide  text-rose-500 transition duration-300 hover:bg-rose-100 hover:text-rose-600 focus:bg-rose-200 focus:text-rose-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:text-rose-300 disabled:shadow-none disabled:hover:bg-transparent"
                ...
                <div className="flex justify-start gap-2">
                  ...
                  <button
                    className="inline-flex h-10 items-center justify-center gap-2 justify-self-center whitespace-nowrap rounded px-5 text-sm font-medium tracking-wide text-rose-500 transition duration-300 hover:bg-rose-100 hover:text-rose-600 focus:bg-rose-200 focus:text-rose-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:text-rose-300 disabled:shadow-none disabled:hover:bg-transparent"
                    onClick={() => setIsShowing(false)}
                  >
                    <span>I Decline</span>
                  </button>
